...
class View(ft.UserControl):
    def __init__(self, page: ft.Page):
        ...
        # page stuff
        self._page = page
        self._page.title = "LAB 09 - Analisi aeroporti"
    ...
    def load_interface(self):
        # title
        self._title = ft.Text("Analisi aeroporti", color="blue", size=24)
        self._page.controls.append(self._title)

        #ROW with some controls
        self.txt_distance = ft.TextField(
            label="Distanza minima percorsa",
            width=250,
            hint_text="Inserisci distanza in miglia (es. 500)")
        ...
        row1 = ft.Row([self.txt_distance, self.btn_analizza],
